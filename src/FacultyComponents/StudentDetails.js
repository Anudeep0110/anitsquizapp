...
const StudentDetails = () => {
    ...
    React.useEffect(() => {
      axios.post('https://anitsquizapp.onrender.com/student-details',{classId:classId,subId:subId}).then((res) => {
        console.log(subId);
        setRes(res.data);
        setTimeout(() => {
          setLoading(false)
    ...
    const data = {
      ...
      const handlePrint = () => {
        console.log("Called");
        axios.post('https://anitsquizapp.onrender.com/download-pdf',{data:data,cName:className,subName:subName},{responseType:'arraybuffer'})
        .then((response) => {
      ...
      const handleEmail =async (e) => {
        e.preventDefault()
        var fileData;
        await axios.post('https://anitsquizapp.onrender.com/download-pdf', { data: data, cName: className, subName: subName }, { responseType: 'arraybuffer' })
          .then((response) => {
        ...
        await axios.post('https://anitsquizapp.onrender.com/send-email',formData,config)
          .then((response) => {
