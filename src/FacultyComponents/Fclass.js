...
const Fclass = () => {
    ...
    const Update = (e) => {
        e.preventDefault();
        axios.post('https://anitsquizapp.onrender.com/update-quiz',{quizId:quizId,quizDate:quizDate,quizTime:quizTime,duration:duration}).then((res) => {
        })
...
return (
    ...
    <div className='d-flex fclass flex-column fclass-bg' style={{minHeight:"100vh",background:"#d3dde3"}}>
        ...
        {isLoading?<Loading />:
        <div className='mb-2 mt-5' id='whole'>
