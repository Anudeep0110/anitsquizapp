...
const AttempQuiz = () => {
    ...
    React.useEffect(() => {
        ...
        axios.post('https://anitsquizapp.onrender.com/attemptquiz',{quizid:quizid,uname:uname})
        .then(response => {
    ...
    const Attempt = () => {
        axios.post('https://anitsquizapp.onrender.com/updatemarks',{quizid:quizid,uname:uname,marks:0,subId:subId})
            .then(res => {
    ...
    const getAnswers =() => {
        axios.post('https://anitsquizapp.onrender.com/getans',{quizid:location.state.quizid,uname:uname})
        .then(res => {
